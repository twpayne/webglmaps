goog.provide('webglmaps.Framebuffer');
 ...
 */
webglmaps.Framebuffer = function(size) {
...
goog.inherits(webglmaps.Framebuffer, webglmaps.GLObject);


/**
 */
webglmaps.Framebuffer.prototype.bind = function() {
  var gl = this.getGL();
 ...
 */
webglmaps.Framebuffer.prototype.createTexture_ = function(size) {
  var gl = this.getGL();
 ...
 */
webglmaps.Framebuffer.prototype.get = function() {
 ...
 */
webglmaps.Framebuffer.prototype.setGL = function(gl) {
 ...
 * @param {number} size Size.
 */
webglmaps.Framebuffer.prototype.setSize = function(size) {
  var gl = this.getGL();
  goog.asserts.assert(!(size & (size - 1)));
